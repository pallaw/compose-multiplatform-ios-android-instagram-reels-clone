...
class ReelRepository {
    ...
    private val staticReelsData: String = "[\n" +
            ...
            "    \"thumb\": \"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToiWCdWSzIBBw3EWdl6O6_hezuPClup5-m7w&usqp=CAU\",\n" +
    ...
    fun getReels(): List<Reel> {
        println(staticReelsData)
        return Json.decodeFromString<Array<Reel>>(staticReelsData).asList()
    }
}